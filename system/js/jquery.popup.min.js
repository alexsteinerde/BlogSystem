...
a.o.hideFlash&&b("object, embed").css("visibility","visible");a.ele&&a.o.activeClass&&b(a.ele).removeClass(a.o.activeClass);var c=b("."+a.o.popupPlaceholderClass);"inline"==l&&c.length&&c.html(p).removeClass(a.o.popupPlaceholderClass);l=null;a.o.afterClose.call(a);return a};a.center=function(){f.css(a.getCenter());g.css({height:document.documentElement.clientHeight});return a};a.getCenter=function(){var a=f.children().outerWidth(!0),b=f.children().outerHeight(!0);return{top:250,left:0.5*document.documentElement.clientWidth-0.5*a}}}})(jQuery,window);

function getPopup (id, text, yesText, yesLink) {
	$(id).popup({content : '<div class="popup_yn" id="yesno">'+text+'<div class="buttons"><a href="'+yesLink+'"><button class="yes">'+yesText+'</button></a><a href=""><button class="no">Nein</button></a></div></div>',
	  type : 'html'
	});
}